...
const hard=fs.readFileSync('blind.tsv','utf8').trim().split('\n').map(l=>l.split('\t'));
...
const n=hard.length;
console.log(`Blind set (${n}): Our AI 6-level ${(100*a6/n).toFixed(0)}%  3-column ${(100*a3/n).toFixed(0)}%  | Keywords 6-level ${(100*k6/n).toFixed(0)}%  3-column ${(100*k3/n).toFixed(0)}%`);
